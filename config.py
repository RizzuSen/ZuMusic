...
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "inteljenberkelas")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "BapkPresiden")
SUDO_USERS = list(map(int, getenv("SUDO_USERS").split()))
COMMAND_PREFIXES = list(getenv("COMMAND_PREFIXES", "/ ! .").split())
ALIVE_IMG = getenv("ALIVE_IMG", "https://telegra.ph/file/360cdc2481c0d16400df0.png")
